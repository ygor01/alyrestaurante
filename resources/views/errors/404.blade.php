...
<html>
	...
	<title>{{ env('APP_NAME') }} - Página não encontrada</title>
	...
	@php $path = \Request::getRequestUri(); @endphp
				...
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<h1 style="font-size: 20pt!important;">404 | Página "<em class="em">{{$path}}</em>" não encontrada</h1>
						</div>
					</div>
				</div>
			</div>
